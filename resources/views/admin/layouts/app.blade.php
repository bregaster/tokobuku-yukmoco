        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              ...
              <li class="menu-item">
                <a href="{{route('bukus.create')}}" class="menu-link">
          ...
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <div data-i18n="Authentications">Gudang</div>
            </a>
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="/daftar-gudang" class="menu-link">
                  <div data-i18n="Basic">Daftar Gudang</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="/tambah-gudang" class="menu-link">
                  <div data-i18n="Basic">Tambah Gudang</div>
                </a>
              </li>
            </ul>
          </li>

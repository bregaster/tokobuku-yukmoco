            ...
            <a href="index" class="app-brand-link">
              <span class="app-brand-logo demo">
                <svg
                  ...
                  <path
                    d="M 0,0 V 425.6376 H 425.6377 V 0 Z"
                    style="fill:none"
                    id="path2" />
                  <path
                    ...
                    style="fill:#66788c;fill-rule:evenodd"
                    id="path4" />
                  <path
                    ...
                    style="fill:#fb3566;fill-rule:evenodd"
                    id="path6" />
                </svg>
              </span>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Pelanggan</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/daftar-pelanggan" class="menu-link">
                    <div data-i18n="Account">Daftar Pelanggan</div>
                  </a>
                </li>
              </ul>
            </li>

 ...
 *   https://datatables.net/download/#bs5/dt-1.12.1/b-2.2.3/sp-2.0.2/sl-1.4.0
 *
 * Included libraries:
 *   DataTables 1.12.1, Buttons 2.2.3, SearchPanes 2.0.2, Select 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.12.1/b-2.2.3/sp-2.0.2/sl-1.4.0",
